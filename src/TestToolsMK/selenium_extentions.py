...
class SeleniumExtentions(object):
    ...
    def __int__(self):
        self.selenium2Instance = BuiltIn().get_library_instance('Selenium2Library')
    ...
    def open_browser_custom_size(self, url, width=WIDTH_DEFAULT, heigh=HEIGHT_DEFAULT, alias=None,
        ...
        self.selenium2Instance.open_browser(self.selenium2Instance, url, browser, alias, remote_url,
                                            desired_capabilities)
        self.selenium2Instance.set_window_size(self.selenium2Instance, width, heigh)
        self.selenium2Instance.set_selenium_speed(self.selenium2Instance, self.SELENIUM_SPEED)
