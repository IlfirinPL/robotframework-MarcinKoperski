...
setup(
    ...
    install_requires=[
        ...
        u'robotframework-archivelibrary', u'robotframework-databaselibrary', u'robotframework-imaplibrary', u'robotframework-pabot',
        u'robotframework-ride>=1.5.2.1',
        u'robotframework-selenium2library>=1.7.4', u'robotframework-testmanagement>=0.1.10', # u'robotframework-sshlibrary>=2.1.1',
        u'robotframework-sudslibrary',
        u'robotframework-appiumlibrary',
        u'gspread', u'unicodecsv', u'oauth2client',
        u'selenium',
